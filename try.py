...
SHORTER_SERVICES = {  # Example list of shortening services (update as needed)
    "bit.ly", "tinyurl.com", "goo.gl", "cutt.ly", "t.co", "is.gd", "shrt.co", "tiny.cc",
    "ow.ly", "buff.ly", "rebrand.ly",
    "bl.ocks.org", "yourls.org", "adfoc.us", "bc.vc", "bit.do", "bitly.com", "bpaste.net",
    "brnd.ly", "bz.im", "clck.ru",
    "clk.sh", "da.gd", "db.tt", "dbrd.co", "dis.gd", "dly.hk", "dnurl.com", "doyour.ws",
    "drve.me", "du.tl", "dwz.io",
    "ebook.io", "ever.io", "fb.me", "ff.im", "fh.st", "ft.tt", "goo.gl", "goo.to", "gurl.me",
    "gv.co",
    "hex.io", "hid.re", "hm.co", "hst.sh", "ht.ly", "icewarp.com", "im.ki", "is.gd", "is.gd/u",
    "it.ly", "j.mp", "k.st", "kartOO.com", "kgs.fm",
    "kl.to", "knowyour.link", "krurl.com", "kut.tl", "leaddy.io", "li.st", "link.tl", "lnk.gd",
    "lnkd.in", "lnki.us", "lrn.li", "lnkurl.io",
    "loo.gl", "lyt.ly", "mcaf.ee", "mcg.io", "me.dm", "mediashare.com", "min.us", "m͎b͎l͎.͎o͎n͎l͎y͎",
    "mightyurl.com", "moourl.com", "mrln.io",
    "mvb.me", "my.id", "myurl.com", "nblo.at", "neu.li", "ninj.ly", "nsfw.in", "oc.lc", "om.ly",
    "ow.ly", "p.tl", "paper.li", "pb.me",
    "pic.gd", "ping.fm", "plr.to", "pnt.st", "po.st", "pow.ερ", "post.ly", "ppt.cc",
    "PressForward.com",
...
@app.route('/')
def home():
    return render_template("index.html")  # Assuming your index.html exists
...
def predict():
    if request.method == 'POST':
        ...
        # Analyze URL features - no change
        url_features = analyze_url(url)

        # Make prediction using the model with the extracted features
        prediction = model.predict([url_features])

        # Update prediction_text without hardcoded messages
        prediction_text = "Safe" if prediction == 1 else "Not Safe"

        return render_template("prediction.html", prediction_text=prediction_text)
    else:
        return render_template("prediction.html")  # Render prediction.html even for GET requests
